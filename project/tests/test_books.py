...
@pytest.mark.parametrize("valid_author", ["Jane Austen", "George Orwell", "Fyodor Dostoevsky"])
...
@pytest.mark.parametrize("invalid_isbn", ["1234567890123", "978123456789", "978123456789X"])
...
@pytest.mark.parametrize(
    "isbn, expected_title",
    [("9780141439518", "Pride and Prejudice"), ("9780452284234", "1984")],
)
